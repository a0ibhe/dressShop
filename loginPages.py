...
class Container(tk.Tk):
    def __init__(self, *args, **kwargs):
        ...
        for F in (m.Container, sd.Dash, cd.Container):
...
class customerLogin(tk.Frame):
    def __init__(self, parent, controller):
        ...
        backButton = tk.Button(self, text="Back", command=lambda: controller.show_frame(m.Container)).grid(row=5, column=2, sticky="s")
...
class staffLogin(tk.Frame):
    def __init__(self, parent, controller):
        ...
        backButton = tk.Button(self, text="Back", command=lambda: controller.show_frame(m.Container)).grid(row=4, column=1, sticky="s")
